if (process.env.NODE_ENV !== 'production') {
  ...
  // Workaround: Node.js v25 c-ares fails to read DHCP DNS on Windows, falling
  // back to 127.0.0.1 (nothing listening). Force a working DNS server in dev.
    ...
    contentSecurityPolicy: {
      directives: {
        ...
        imgSrc: [
          ...
          'blob:',
          'data:',
          'https://res.cloudinary.com/onestep-webdev/', //SHOULD MATCH YOUR CLOUDINARY ACCOUNT!
          'https://images.unsplash.com/',
        ],
        fontSrc: ["'self'", ...fontSrcUrls],
        mediaSrc: ['https://res.cloudinary.com/onestep-webdev/'],
        childSrc: ['blob:'],
      },
    },
